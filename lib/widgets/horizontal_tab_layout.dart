...
import 'package:theforum/widgets/forum_card.dart';
import 'package:theforum/widgets/tab_text.dart';
...
class _HorizontalTabLayoutState extends State<HorizontalTabLayout>
  ...
  List<Widget> getList(index) {
    return [
    [
      ForumCard(forum: algorithmForum),
      ForumCard(forum: systemDesignForum)
    ]
    ,
    [
    ForumCard(forum: systemDesignForum),
